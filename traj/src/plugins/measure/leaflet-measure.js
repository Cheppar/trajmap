! function(e) {
    ...
    L.Control.Measure = L.Control.extend({
        ...
        _initLayout: function() {
            ...
            this._collapse(), this._updateMeasureNotStarted(), L.Browser.android || (L.DomEvent.on(t, "mouseenter", 
            this._expand, this), L.DomEvent.on(t, "mouseleave", 
            this._collapse, this)), 
            L.DomEvent.on(r, "click", L.DomEvent.stop), L.Browser.touch ? L.DomEvent.on(r, "click", this._expand, this) : L.DomEvent.on(r, "focus", this._expand, this), L.DomEvent.on(n, "click", L.DomEvent.stop), L.DomEvent.on(n, "click", this._startMeasure, this), L.DomEvent.on(o, "click", L.DomEvent.stop), L.DomEvent.on(o, "click", this._finishMeasure, this), L.DomEvent.on(i, "click", L.DomEvent.stop), L.DomEvent.on(i, "click", this._handleMeasureDoubleClick, this)
        },
        _expand: function() {
        ...
        _handleMeasureDoubleClick: function() {
            ...
            var i = (0, c.selectOne)(".paypal", o );
                ...
                var z = (0, c.selectOne)(".paypal", o);
                
                    L.DomEvent.on(z, "click", function  initPayPalButton() {
      paypal.Buttons({
        style: {
          shape: 'rect',
          color: 'gold',
...
function(e, t, r) {
    ...
    e.exports = '<div class="white"><h3 class="para">Parcel Data</h3> <p>{{ model.areaDisplay }}</p> <p>{{ model.lengthDisplay }} Perimeter</p> <ul class=tasks> <li><a href=# class="">Request</a></li> <li><button id="prev-btn" class="paypal">PayPal Payment</button></a></li> <li><a href=# class="js-deletemarkup deletemarkup">Delete</a></li> </ul> <div id="smart-button-container"><div style="text-align: center;"><div id="paypal-button-container"></div></div></div> </div>'
}]);